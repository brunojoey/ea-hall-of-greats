...
const xboxSeries = "Xbox Series X|S";
...
const gameSeed = [
  ...
  },
  {
    ...
    game: megaManX,
    hallOfGreat: 19,
    description: "Mega Man X is an action-platform video game developed and published by Capcom for the Super Nintendo Entertainment System (SNES). It was the first Mega Man game for the 16-bit console and the first game in the Mega Man X series, a spin-off of the original Mega Man series that began on the SNES's predecessor, the Nintendo Entertainment System (NES). Mega Man X was released in Japan on December 17, 1993 and was released in both North America and Europe the following year. Taking place a century after the original Mega Man series, Mega Man X is set in a futuristic world populated by both humans and 'Reploids', robots capable of thinking, feeling, and growing like their human creators. Because of these complex attributes, many Reploids are prone to destructive, renegade activity and are thereafter referred to as 'Mavericks'. The plot of the game follows the protagonist Mega Man X, an android member of a military task force called the 'Maverick Hunters'. With the help of his partner Zero, X must thwart the plans of Sigma, a powerful Maverick leader wishing to bring about human extinction.",
    genre: action,
    year: 1993,
    platforms: superNES,
    metacritic: "97",
  ...
  },
  {
    ...
    game: sonicMania,
    hallOfGreat: 19,
    description: "It's the ultimate Sonic celebration! Sonic returns in a new 2D platforming high speed adventure, and he's not alone! Developed in collaboration between SEGA, Christian Whitehead, Headcannon, and PagodaWest Games, experience new zones and remixed classic levels with Sonic, Tails, and Knuckles!",
    genre: platformer,
    year: 2017,
    platforms: ps4 + ", " + xboxOne + ", " + nSwitch + ", " + pc,
    metacritic: "86",
  ...
  },
  {
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co3wsm.png",
    alt: "Outer Wilds",
    allyLink: "isla_hinck",
    hallLink: "hall_great_nineteen",
    infoLink: "https://en.wikipedia.org/wiki/Outer_Wilds",
  },
  {
    ally: danielBloodworth,
    game: "Final Fantasy IV",
    hallOfGreat: 19,
    description: "FINAL FANTASY IV is the fourth main installment in the FINAL FANTASY series, developed and published by Squaresoft. It was released in July 1991 for the Super Famicom System in Japan, and released as FINAL FANTASY II in North America in October 1991 for the Super Nintendo Entertainment System with alterations made due to Nintendo of America's guidelines at the time. The game saw a re-release in Japan on the WonderSwan Color and a global release on PlayStation under its original name as part of the FINAL FANTASY CHRONICLES and FINAL FANTASY ANTHOLOGY collections.",
    genre: japaneseRPG,
    year: 1991,
    platforms: superNES,
    metacritic: "87",
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co31c0.png",
    alt: "Final Fantasy IV",
    allyLink: 'daniel_bloodworth',
    hallLink: 'hall_great_nineteen',
    infoLink: "https://en.wikipedia.org/wiki/Final_Fantasy_IV",
  },
  {
    ally: michaelHuber,
    game: timeCrisis2,
    hallOfGreat: 19,
    description: "Time Crisis II is a light gun arcade game and the second installment in Namco's Time Crisis series, introducing co-operative multiplayer to the franchise. It was released in arcades in December 1997, with an enhanced port released on the PlayStation 2 in October 2001, bundled with the GunCon 2 controller (G-Con 2 in Europe). Ports for the original PlayStation and Dreamcast were in development, but were cancelled.",
    genre: "Light Gun Shooter",
    year: 1997,
    platforms: arcade,
    metacritic: "81",
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co1p35.png",
    alt: timeCrisis2,
    allyLink: "michael_huber",
    hallLink: "hall_great_nineteen",
    infoLink: "https://en.wikipedia.org/wiki/Time_Crisis_II",
  },
  {
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co2ea6.png",
    alt: "Star Wars Trilogy Arcade",
    allyLink: "michael_damiani",
    hallLink: "hall_great_nineteen",
    infoLink: "https://en.wikipedia.org/wiki/Star_Wars_Trilogy_Arcade",
  },
  {
    ally: bradEllis,
    ...
    genre: "Sports",
    year: 2020,
    platforms: ps5 + ", " + ps4 + ", " + xboxSeries + ", " + xboxOne + ", " + pc + ", " + nSwitch,
    metacritic: "89",
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co25u7.png",
    alt: "Tony Hawk's Pro Skater 1+2",
    allyLink: "brad_ellis",
    hallLink: "hall_great_twenty",
    infoLink: "https://en.wikipedia.org/wiki/Tony_Hawk's_Pro_Skater_1_%2B_2",
  },
  {
    ally: donCasanova,
    game: "Rayman Origins",
  ...
  },
  {
    ...
    hallOfGreat: 20,
    description: "Kingdom Hearts II is an action role-playing game, and the primary entry to the series since the 2002 Disney Interactive and Square collaboration. The game's setting is a collection of various levels (referred to in-game as 'worlds') that the player progresses through. As in the first game, II allows the player to travel to locales from various Disney worlds, along with original worlds specifically created for the series.",
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co30t1.png",
    alt: "Kingdom Hearts II",
    allyLink: "isla_hinck",
    hallLink: "hall_great_twenty",
    infoLink: "https://en.wikipedia.org/wiki/Kingdom_Hearts_II",
  },
  {
    ally: danielBloodworth,
    game: "F-Zero GX",
    ...
    platforms: gameCube,
    metacritic: "89",
    developer: "Amusment Visions",
    publisher: "Nintendo",
    votes: 9,
    victory: "True",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co525x.png",
    alt: "F-Zero GX",
    allyLink: 'daniel_bloodworth',
    hallLink: "hall_great_twenty",
    infoLink: "https://en.wikipedia.org/wiki/F-Zero_GX",
  },
  {
    ally: michaelHuber,
    game: "Red Dead Redemption II",
    hallOfGreat: 20,
    description: "Red Dead Redemption II is the epic tale of outlaw Arthur Morgan and the infamous Van der Linde gang, on the run across America at the dawn of the modern age.",
    genre: actionAdventure,
    year: 2018,
    platforms: ps4 + ", " + xboxOne + ", " + pc,
    metacritic: "97",
    ...
    allyLink: "michael_huber",
    hallLink: "hall_great_twenty",
    infoLink: "https://en.wikipedia.org/wiki/Red_Dead_Redemption_2",
  },
  {
    ally: michaelDamiani,
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co21yv.png",
    alt: "Super Smash Bros. Melee",
    allyLink: "michael_damiani",
    hallLink: "hall_great_twenty",
    infoLink: "https://en.wikipedia.org/wiki/Super_Smash_Bros._Melee",
  },
  {
    ally: bradEllis,
    game: "Sekiro: Shadows Die Twice",
  ...
  },
  {
    ...
    year: 1996,
    platforms: "Neo Geo AES, Neo Geo CD, Sega Saturn, " + ps1 + ", " + arcade,
    metacritic: "84",
    ...
    victory: "True",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co20gf.png",
    alt: "Metal Slug",
    allyLink: "don_casanova",
    hallLink: "hall_great_twentyone",
    infoLink: "https://en.wikipedia.org/wiki/Metal_Slug_(1996_video_game)",
  },
  {
    ally: islaHinck,
    game: "Metal Gear Solid 3: Snake Eater",
  ...
  },
  {
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co4ulc.png",
    alt: "Pac-Man",
    allyLink: 'daniel_bloodworth',
    hallLink: "hall_great_twentyone",
    infoLink: "https://en.wikipedia.org/wiki/Pac-Man",
  },
  {
    ally: michaelHuber,
    ...
    victory: "False",
    banned: "False",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co3wou.png",
    alt: "Teenage Mutant Ninja Turtles III: The Manhattan Project",
    allyLink: "michael_huber",
    hallLink: "hall_great_twentyone",
    infoLink: "https://en.wikipedia.org/wiki/Teenage_Mutant_Ninja_Turtles_III:_The_Manhattan_Project",
  },
  {
    ally: michaelDamiani,
    ...
    genre: "Fighting",
    year: 2001,
    platforms: ps3 + ", " + xbox360 + ", " + pc + ", " + arcade,
    metacritic: "93",
    developer: "Capcom",
    publisher: "Capcom",
    votes: 0,
    victory: "False",
    banned: "True",
    image: "https://images.igdb.com/igdb/image/upload/t_cover_big/co1w4t.png",
    alt: "Street Fighter IV",
    allyLink: "michael_damiani",
    hallLink: "hall_great_twentyone",
    infoLink: "https://en.wikipedia.org/wiki/Street_Fighter_IV",
  }
];
