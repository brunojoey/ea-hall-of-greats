...
// function AllyFilter(props) {
//   const [ally, setAlly] = useState([]);
//   const { history } = props;
//   const allies = ['Ben Moore', 'Daniel Bloodworth', 'Brandon Jones', 'Brad Ellis', 'Michael Huber', 'Michael Damiani', 'Kyle Bosman', 'Ian Hinck', 'Don Casanova']

//   useEffect(() => {
//     async function fetchData() {
//       let { data } = await gamesAPI.getGames();
//       console.log("DATA", data);
//       data = data.filter((games) => games.ally);
